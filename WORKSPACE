...
#
github_hugo_theme(
    name = "com_github_jacobsun_edidor",
    owner = "jacobsun",
    repo = "edidor",
    commit = "81e34d409f53b7c2fde606f0bfe9c420818e62d0",
)
github_hugo_theme(
...
go_repository(
    ...
    sum = "h1:IWHgpgFqnL5AhBUBZSgBdjl2vkQUEzcY+JNKWfcgAU0=",
    version = "v0.0.0-20190606173856-1492cefac77f",
)

go_repository(
    name = "org_golang_google_genproto",
    importpath = "google.golang.org/genproto",
    sum = "h1:4rNOqY4ULrKzS6twXa619uQgI7h9PaVd4ZhjFQ7C5zs=",
    version = "v0.0.0-20190522204451-c2c4e71fbf69",
)
...
## Protoc-gen-doc, for generating documentation
load("//:protoc-gen-doc.bzl", "proto_gen_doc_deps")
go_repository(
